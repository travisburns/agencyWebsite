...
const Testimonials = () => {
    ...
    <div>
        <div className='testimonials text-center font-Poppins text-white'>
            ...
            <div className='testimonials_scroller-item rounded-lg bg-slate-950  relative w-3/5 mb-5 left-[4rem] sm:left-[8rem] xl:w-[37rem] 2xl:w-[70.2rem] 2xl:left-[24rem]'>
                    ...
                    <div className='testimonials_scroller-item_clientInfo-role text-[9px] sm:text-[20px] xl:text-[27px]'>CEO of Apple's to oranges</div>
                    </div>
                    </div>
                    </div>
                </div>
                ...
                <div className='testimonials_scroller-item rounded-lg bg-slate-950  relative w-3/5 mb-5 left-[4rem] sm:left-[8rem] xl:left-[24rem]'>
                    <p className='testimonials_scroller-item_title  mb-10 pt-5'>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                        Doloremque eaque voluptates mollitia ut accusantium exercitationem.
                    </p>
