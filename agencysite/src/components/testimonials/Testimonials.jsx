...
const Testimonials = () => {
    ...
    <div>
        <div className='testimonials text-center font-Poppins text-white'>
            ...
            <div className='testimonials_scroller-item rounded-lg bg-slate-950  relative w-3/5 mb-5 left-[4rem] sm:left-[8rem] xl:left-[19rem]'>
                    ...
                    <img src={testimonialImg} className='testimonials_scroller-item_clientInfo-img h-[3rem] w-[3rem] sm:h-[6rem] sm:w-[6rem]'/>
                    <div className='testimonials_scroller-item_clientInfo-text relative left-[.5rem]'>
                    <div className='testimonials_scroller-item_clientInfo-name sm:text-[25px]'>Mickael Grants</div>
                    <div className='testimonials_scroller-item_clientInfo-role text-[9px] sm:text-[20px]'>CEO of Apple's to oranges</div>
                    </div>
                    </div>
                    </div>
                </div>
